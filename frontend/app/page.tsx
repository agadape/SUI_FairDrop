    ...
    <section className="relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 pt-4 pb-10 lg:pt-6 lg:pb-14 grid lg:grid-cols-[1.85fr_1fr] gap-4 lg:gap-5 items-stretch">
        ...
        >
          ...
          <motion.div
            aria-hidden
            className="pointer-events-none absolute bottom-2 -right-[8%] z-0 hidden sm:block h-[70%] w-[50%] lg:h-[80%] lg:w-[53%] bg-[url('/illustrations/mobile-encryption.svg')] bg-contain bg-right-bottom bg-no-repeat opacity-90"
